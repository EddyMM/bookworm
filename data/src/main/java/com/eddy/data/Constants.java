...
public abstract class Constants {
    public static final String API_KEY_REQUEST_KEY = "api-key";
    public static final String NEW_YORK_TIMES_API_KEY = "cGMWpjip5qrzqAtFeWMAbtpFJnJhbA5s";
    public static final String NEW_YORK_TIMES_API_BASE_URL = "https://api.nytimes.com/svc/books/v3/";
